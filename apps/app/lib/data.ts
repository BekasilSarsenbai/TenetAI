...
// Insights tab content for demo notes (themes + who-said-what), HTML <b> allowed.
export const INSIGHTS = {
  themes: [
    "Отток на <b>онбординге</b> — главная утечка активации.",
    "Контекст теряется между синками и съедает первые минуты.",
    "Цена перестаёт быть возражением, когда видна экономия времени.",
  ],
  speakers: [
    "<b>Дэв</b> — обозначил, что отток случается до ключевой функции.",
    "<b>Майя</b> — подняла потерю контекста между встречами.",
    "<b>Прия</b> — закрыла ценовое возражение через сэкономленное время.",
  ],
};
